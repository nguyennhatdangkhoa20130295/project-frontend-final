            ...
            <header className="tech-header header">
                <div className="container-fluid">
                    <nav className="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                        ...
                        <a className="navbar-brand" href="tech-index.html"><img src="assets/images/version/tech-logo.png"
                                                                                alt="" /></a>
                                                ...
                                                <div className="mega-menu-content clearfix">
                                                    <div className="tab">
                                                        ...
                                                        <button className="tablinks"
                                                                onClick="openCategory(event, 'cat02')">Technology
                                                        </button>
                                                        <button className="tablinks"
                                                                onClick="openCategory(event, 'cat03')">Social Media
                                                        </button>
                                                        <button className="tablinks"
                                                                onClick="openCategory(event, 'cat04')">Car News
                                                        </button>
                                                        <button className="tablinks"
                                                                onClick="openCategory(event, 'cat05')">Worldwide
                                                        </button>
                                                    </div>
                                                            ...
                                                            <div className="row">
                                                                    ...
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_01.jpg"
                                                                        ...
                                                                        <div className="blog-meta">
                                                                            <h4><a href="tech-single.html" title="">Top
                                                                                10+ care advice for your toenails</a>
                                                                            </h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_02.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                                        className="menucat">Science</span>
                                                                            </a>
                                                                        </div>
                                                                        <div className="blog-meta">
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_03.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_04.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_05.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                                        className="menucat">Technology</span>
                                                                            </a>
                                                                        </div>
                                                                        <div className="blog-meta">
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_06.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_07.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                        ...
                                                                        <div className="blog-meta">
                                                                            <h4><a href="tech-single.html" title="">Subscribe
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_08.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                        ...
                                                                        <div className="blog-meta">
                                                                            <h4><a href="tech-single.html" title="">The
                                                                                most trends of this year with color
                                                                                combination</a></h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_09.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_10.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span className="menucat">Social Media</span>
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_11.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span className="menucat">Social Media</span>
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_12.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span className="menucat">Social Media</span>
                                                                        ...
                                                                        <div className="blog-meta">
                                                                            <h4><a href="tech-single.html" title="">One
                                                                                of the most beautiful ports in the
                                                                                world</a></h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_13.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                                        className="menucat">Car News</span>
                                                                            </a>
                                                                        </div>
                                                                        <div className="blog-meta">
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_14.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                        ...
                                                                        <div className="blog-meta">
                                                                            <h4><a href="tech-single.html" title="">America's
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_15.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                        ...
                                                                        <div className="blog-meta">
                                                                            <h4><a href="tech-single.html" title="">The
                                                                                most professional ways to color your
                                                                                walls</a></h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_16.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_17.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                                        className="menucat">Worldwide</span>
                                                                            </a>
                                                                        </div>
                                                                        <div className="blog-meta">
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_18.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_19.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
                                                                ...
                                                                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                                    <div className="blog-box">
                                                                        <div className="post-media">
                                                                            <a href="tech-single.html" title="">
                                                                                <img src="assets/upload/tech_menu_20.jpg"
                                                                                     alt="" className="img-fluid" />
                                                                                    <div className="hovereffect">
                                                                                    </div>
                                                                                    <span
